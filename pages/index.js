			...
			<section>
				...
				<div className='grid grid-cols-1 md:grid-cols-2 pt-10 gap-10'>
					<p className='text-slate text-lg md:text-xl font-semibold col-span-1'>
						...
						University of West London with a Bachelor’s Degree in Cyber Security
						and I am passionate about Web Development. Now, I’m looking for an
						opportunity to further develop my current skill set as a Junior
						Developer.
					</p>
